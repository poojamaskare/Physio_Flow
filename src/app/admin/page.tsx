        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
            ...
            <main className="max-w-6xl mx-auto px-8 py-10">
                <div className="mb-10">
                    ...
                    <span className="inline-block px-4 py-1.5 bg-amber-500/15 border border-amber-500/30 rounded-full text-amber-400 text-sm font-semibold uppercase tracking-wide">
                        Admin Dashboard
                    </span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="relative p-8 bg-slate-800/80 backdrop-blur-xl border border-white/10 rounded-2xl opacity-60">
                        ...
                        <p className="text-slate-400">View, approve, and manage doctor accounts</p>
                    ...
                    <div className="relative p-8 bg-slate-800/80 backdrop-blur-xl border border-white/10 rounded-2xl opacity-60">
                        ...
                        <p className="text-slate-400">View all patients and reassign doctors</p>
                        <span className="absolute bottom-6 right-6 px-3 py-1 bg-amber-500/15 border border-amber-500/30 rounded-full text-amber-400 text-xs font-semibold uppercase">
                            Coming Soon
                        </span>
                    </div>
                    ...
                    <div className="relative p-8 bg-slate-800/80 backdrop-blur-xl border border-white/10 rounded-2xl opacity-60">
                        ...
                        <p className="text-slate-400">Manage all exercise videos</p>
                        <span className="absolute bottom-6 right-6 px-3 py-1 bg-amber-500/15 border border-amber-500/30 rounded-full text-amber-400 text-xs font-semibold uppercase">
                            Coming Soon
                        </span>
                    </div>
                    ...
                    <div className="relative p-8 bg-slate-800/80 backdrop-blur-xl border border-white/10 rounded-2xl opacity-60">
                        ...
                        <p className="text-slate-400">Platform statistics and reports</p>
                        <span className="absolute bottom-6 right-6 px-3 py-1 bg-amber-500/15 border border-amber-500/30 rounded-full text-amber-400 text-xs font-semibold uppercase">
                            Coming Soon
                        </span>
                    </div>
